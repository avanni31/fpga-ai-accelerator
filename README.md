...
## Verify the Simulation Yourself

You can run and verify the simulation output directly on this repository — no tools or installation needed.

1. Click the **Actions** tab at the top of this repo
2. Click the most recent **"Run Simulation"** workflow run
